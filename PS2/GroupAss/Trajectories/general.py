...
mPays = [100*u.kg, 200*u.kg]
mKicks = [1924*lbUnit, 1485.7*lbUnit, 1196.7*lbUnit, 810.9*lbUnit, 796.2*lbUnit, 579*lbUnit, 662.3*lbUnit]
mProps = [1698*lbUnit, 1392*lbUnit, 1113.6*lbUnit, 744.8*lbUnit, 735.6*lbUnit, 511.4*lbUnit, 601.6*lbUnit]
Isps = [286.97*u.s, 290.4*u.s, 292.3*u.s, 291.4*u.s, 287.9*u.s, 272.1*u.s, 286.5*u.s]
stageNames = ["Orion 38", "STAR 30E", "STAR 30BP", "STAR 27H", "STAR 27", "STAR 26C", "STAR 20"]
DVs = []
